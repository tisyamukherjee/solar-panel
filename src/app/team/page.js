...
export default function Team() {
    return (
      <div className="bg-white">
        <h1
          className="text-6xl text-center font-bold pb-5 pt-15 font-montserrat"
          style={{ color: "#00274C" }}
        >
          Meet The Team
        </h1>
        <div className="px-20">
          ...
          <div className="flex flex-row ml-10 justify-between flex-wrap">
            ...
            />
            <ProfileCard
              headshot="/headshots/mia.jpg"
              fullname="Mia Tursman"
              role="Team Member"
              link="https://www.linkedin.com/in/mia-tursman"
            />
            <div className="flex flex-row ml-35 gap-15">
              <ProfileCard
          ...
          <p className="text-black py-4 font-montserrat">
            Students for Clean Energy promotes awareness and implementation of
            renewable energy at the University of Michigan. We challenge the
            status quo of burning emissions-producing fuels at U-M and works to
            promote a just transition towards clean energy.
          </p>
          {/* images */}
